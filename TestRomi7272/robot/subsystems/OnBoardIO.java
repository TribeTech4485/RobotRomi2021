...
public class OnBoardIO extends SubsystemBase {
  ...
  public OnBoardIO(ChannelMode dio1, ChannelMode dio2) {
    System.out.println("OnBoardIO constructor  dio1: " + dio1 + " dio2: " + dio2);
  ...
  public boolean getButtonAPressed() {
    //System.out.println(MessageFormat.format("getButtonA {0}", m_buttonA.get()));
  ...
  public boolean getButtonBPressed() {
    if (m_buttonB != null) {
      //System.out.println(MessageFormat.format("getButtonB {0}", m_buttonB.get()));
