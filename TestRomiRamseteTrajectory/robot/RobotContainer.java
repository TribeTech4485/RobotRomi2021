...
public class RobotContainer {
  ...
  private Command generateRamseteCommand() {
    ...
    TrajectoryConfig config = 
          new TrajectoryConfig(AutoConstants.kMaxSpeedMetersPerSecond,
              ...
              // apply the voltage constraint created above
  ...
  private void configureButtonBindings() {
    ...
    m_chooser.setDefaultOption("Drive Time", new DriveTime(0.50, 4.0, m_drivetrain));
    m_chooser.addOption("Drive Distance", new DriveDistance(0.50, 0.75, m_drivetrain));
